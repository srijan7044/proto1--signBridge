...
├── process_asl.py             # Process and normalize ASL alphabet dataset samples
├── single_dataset_combine.py  # Combine gesture datasets into a training CSV
...
├── out_centered.mp4           # Generated sign animation sample
├── out_test.mp4               # Generated sign animation test output
├── *.frames.npy / *.spans.npy # Landmark frames and word-span metadata for video outputs
...
├── data/                      # Training datasets and source dataset directories
│   ├── gestures.csv           # Primary gesture training data
│   ├── gestures_synthetic.csv # Synthetic gesture training data
│   ├── gestures_combined.csv  # Combined gesture dataset
│   ├── gestures_letters*.csv  # Letter-sign datasets and variants
│   ├── asl_dataset/            # ASL alphabet source data
│   ├── a_to_h/                 # Additional alphabet samples
│   └── Indian Sign Language Alphabet Dataset/ # Additional sign-language dataset
